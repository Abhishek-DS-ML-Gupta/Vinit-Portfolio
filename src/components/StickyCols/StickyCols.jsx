        ...
        <section className="sticky-cols w-screen h-dvh overflow-hidden bg-[#181717] lg:mb-20">
            <div className="sticky-cols-wrapper relative w-full h-screen">
                <div className="col col-1">
                    <div className="col-content">
                        <div className="col-content-wrapper">
                            <h1 className="text-2xl text-[#b1a696] font-bold leading-auto">Advanced
                                <br />
                                Data—Modeling
                                <br />
                                for Real-time
                            ...
                            <div className="col-content-para flex items-center gap-4 justify-between">
                                ...
                                <p className={`text-[12px] font-medium  ${!reveal ? "mr-6" : "mr-0"}`}> Architecting scalable neural networks that solve
                                    <br />
                                    complex real-world problems with precision.
                                </p>
                            </div>
                ...
                <div className="col col-3">
                    <div className="col-content-wrapper">
                        <h1 className="text-2xl font-bold leading-auto">Neural
                            <br />
                            Architecture—Search
                            <br />
                            and Hyperparameter
                        ...
                        <div className={`col-content-para flex items-center gap-4 justify-between ${reveal ? "ml-0" : "ml-6"}`}>
                            ...
                            <p className="text-[12px] font-medium"> Optimized training pipelines that maximize
                                <br />
                                model performance while minimizing latency.
                            </p>
                        </div>
                    </div>
                    <div className="col-content-wrapper-2">
                        <h1 className="text-2xl font-bold leading-auto">Insightful
                            <br />
                            Data—Visuals
                            <br />
                            and Statistical
                        ...
                        <div className="col-content-para flex items-center gap-4 justify-between">
                            ...
                            <p className={`text-[12px] font-medium  ${!reveal ? "mr-0" : "mr-6"}`}> Transforming high-dimensional data into 
                                <br />
                                interpretable and actionable business intelligence.
                            </p>
                        </div>
                    </div>
                </div>
