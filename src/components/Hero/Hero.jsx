...
const Hero = () => {
    ...
    return (
        <section id="home" className="hero-section w-dvw md:h-dvh h-[100vh] md:p-2 p-2.5 mb-20">
            <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden">
                <div className="responsive-mobile">
                    {/* Background image (down layer) */}
                    <div className="hero-img absolute inset-0 bg-[url('./assets/man.png')] bg-no-repeat bg-cover bg-center z-0 md:block hidden" />
                    ...
                    <div className="relative h-dvh">
                        ...
                        <div className="w-full h-auto absolute  top-24 md:bottom-[8%] lg:bottom-[9%] flex md:flex-row flex-col md:justify-between md:items-end">
                            ...
                            <p
                                ...
                                style={{ textShadow: '2px 2px 4px #000' }}
                            >
                                Specialized in building intelligent systems that transform raw data into actionable insights—Vinit Ghanekar.
                            </p>
                        </div>
                    </div>
                </div>
