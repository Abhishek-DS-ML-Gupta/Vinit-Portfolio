...
const Choose = () => {
    ...
    return (
        <section id="skills" className="choose-section w-full h-dvh p-8 pt-10">
            <p className='text-[.7rem] text-[#eae5dd] choose-subtitle'>Explore My Expertise</p>
            ...
            <div className="choose-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                <div className='lg:w-1/2 w-full text-[#b1a696] lg:text-[2rem] text-[1rem] md:leading-[1.1] lg:mt-0 mt-8 lg:pr-16'>
                    <p>My expertise covers a wide range of ML and AI domains. From classical statistics to state-of-the-art deep learning, I build solutions tailored to complex data challenges.</p>
                </div>
                <div className='lg:w-1/2 w-full'>
                    <div className=" lg:w-[30%] w-[60%]">
                        <p className="text-[.7rem] text-[#eae5dd]">Core Technical
                            Competencies:</p>
                    </div>
